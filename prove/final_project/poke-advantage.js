...
const pokemon = [
  ...
  { name: ['Aerodactyl'], type: ['Rock', 'Flying'], description: "A fierce ancient Pokémon that ruled the skies.", image: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/142.png" },

  { name: ['Snorlax'], type: ['Normal'], description: "It sleeps most of the day and only wakes to eat.", image: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/143.png" },

  { name: ['Articuno'], type: ['Ice', 'Flying'], description: "A legendary bird that chills the air with each flap.", image: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/144.png" },
  { name: ['Zapdos'], type: ['Electric', 'Flying'], description: "A legendary bird that crackles with lightning.", image: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/145.png" },
  { name: ['Moltres'], type: ['Fire', 'Flying'], description: "A legendary bird that blazes with intense flames.", image: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/146.png" },

  { name: ['Dratini'], type: ['Dragon'], description: "A rare dragon Pokémon that grows stronger over time.", image: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/147.png" },
  { name: ['Dragonair'], type: ['Dragon'], description: "Its elegant body radiates a gentle, mystical aura.", image: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/148.png" },
  { name: ['Dragonite'], type: ['Dragon', 'Flying'], description: "A kind-hearted dragon that can circle the globe in hours.", image: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/149.png" },

  { name: ['Mewtwo'], type: ['Psychic'], description: "A powerful Pokémon created through genetic manipulation.", image: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/150.png" },
  { name: ['Mew'], type: ['Psychic'], description: "A playful mythical Pokémon said to contain the DNA of all others.", image: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/151.png" }
];
